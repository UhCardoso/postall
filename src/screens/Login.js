...
import { loginUser } from "../store/actions/user"; // Importando a ação de login
...
const Login = ({ navigation }) => {
    ...
    function handleLogin() {
        dispatch(loginUser({ name, email, password })); // Disparando a ação de login com os dados do usuário
